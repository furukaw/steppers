...
type v = Var of string                    (* x *)
       ...
       | Cont of string * cont_in         (* fun x => e *)
...
and cont_in = FId
            | FApp2 of e * cont_in  (* F[e [.]] *)
            | FApp1 of v * cont_in  (* F[[.] v] *)

and cont_out = GId
             | GReset of cont_in * cont_out
...
let rec plug_in_reset (e : e) (cont_in : cont_in) = match cont_in with
  | FId -> e
  | FApp2 (e1, cont_in) -> plug_in_reset (App (e1, e)) cont_in
  | FApp1 (v2, cont_in) -> plug_in_reset (App (e, (Val v2))) cont_in

let rec plug_all (e : e) ((cont_in, cont_out) : cont) =
