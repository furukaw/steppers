...
and a = Return of v
      | OpCall of string * v * ctxt * cont

and cont = FId
         | FApp2 of e * ctxt * cont        (* e1, ctxt_in, ctxt_out, cont *)
         | FApp1 of v * ctxt * cont        (* v2, ctxt_in, ctxt_out, cont *)
         | FOp of string * ctxt_in * cont  (* op, ctxt_in, cont *)
         | FWith of e * ctxt * cont        (* e2, ctxt_in, ctxt_out, cont *)
         | FCont of cont * cont
